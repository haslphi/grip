...
public class AbstractDAO {
	 ...
	 * @return singleton GripEntityManager
	 */
	protected EntityManager getEM() {
		return GripEntityManager.getInstance().getEntityManager();
	}
	...
	protected void beginSession() {
		GripEntityManager.getInstance().beginSession();
	}
	...
	protected void closeSession() {
		GripEntityManager.getInstance().closeSession();
	}
